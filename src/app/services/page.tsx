        ...
        <div className="mt-12 divide-y divide-line border-y border-line bg-white">
          {services.map((service, index) => (
            ...
            >
              ...
              <Link
                className="focus-ring inline-flex min-h-12 min-w-28 items-center justify-center self-start border border-line bg-white px-5 py-3 text-sm font-semibold text-ink transition hover:border-ink hover:bg-paper active:translate-y-px md:self-center"
